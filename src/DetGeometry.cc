...
G4VPhysicalVolume* DetGeometry::Construct(){
    ...
    new G4PVPlacement(new G4RotationMatrix(90*deg,90*deg,0),G4ThreeVector(5*cm,0,0),scin_CH_log,"scin_CH_PVP",logicWorld,false,0);
    ...
    new G4PVPlacement(new G4RotationMatrix(90*deg,90*deg,0),G4ThreeVector(-100*cm,0,0),scin_YAP_log,"scin_YAP_PVP",logicWorld,false,0);
